...
Restart OpenCode. The plugin auto-loads from `.opencode/plugins/` with all 9 agents (director, planner, implementer, etc.) and commands (`/phase-status`, `/approve-phase`, etc.).
